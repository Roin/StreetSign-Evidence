...
\newcommand{\pdftitel}{Entwicklung eines Online Kochbuchs mithilfe Java Server Pages und Hibernate}
\newcommand{\autor}{Christian Burkard}
\newcommand{\arbeit}{Webengineering II}

\input{header} 

% Ab jetzt können auch Umlaute verwendet werden
\newcommand{\titel}{Entwicklung eines Online Kochbuchs mithilfe von Java Server Pages und Hibernate}
\newcommand{\martrikelnr}{4206853}
...
\newcommand{\betreuer}{Prof. Dr. Barbara Dörsam}
%\newcommand{\zeitraum}{}
